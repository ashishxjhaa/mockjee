    ...
    return (
        <div className="min-h-screen bg-[#F6F6EF] flex items-center justify-center flex-col gap-10">
            ...
            <div className="flex flex-col sm:flex-row gap-5">
                <div className="flex flex-col gap-3 w-fit h-fit p-4 sm:p-6 rounded-xl bg-white hover:-translate-y-2 hover:shadow-lg transition-transform duration-550 shadow-[#FE6603]/50">
